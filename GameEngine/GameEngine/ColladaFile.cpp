...
void CColladaFile::ReadSkin(xml_node<>* root, vector<Vector4>& weights, vector<BVector4>& indices)
{
	//读取蒙皮
...
void CColladaFile::ReadMesh(xml_node<>* root, vector<Vector4>& weights, vector<BVector4>& weight_indices)
{
